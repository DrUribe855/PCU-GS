...
?>
    ...
    <body>
        <div class="background d-flex justify-content-center align-items-center min-vh-100">
            ...
            <form class="form" action="../inc/recovery.php" method="POST">
                <p id="heading"><strong>Recuperación de cuenta</strong></p>
                ...
                <div class="field">
                    ...
                    <input autocomplete="off" placeholder="Nombre de usuario (Nombre_Apellido)" name="username" class="input-field" type="text">
                </div>
                <!-- <div class="field">
                    <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <button class="button3 m-0 mt-4 mb-4">Recuperar contraseña</button>
            </form>
        </div>
